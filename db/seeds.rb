...
medication_orders = MedicationOrder.create([
                                               {name: 'Acetaminophen', unit: 'mg', dosage: '500', necessity: 'relieve swelling', route: 'PO', patient_id: 1, order_frequency_id: '1'},
                                               {name: 'Naproxen', unit: 'mg', dosage: '500', necessity: 'relieve swelling', route: 'PO', patient_id: 1, order_frequency_id: '1'},
...
diagnostic_procedures = DiagnosticProcedure.create([
                                                       {description: 'exploratory radiography', moment: Time.now, patient_id: 1},
